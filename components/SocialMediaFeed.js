...
// Mock data for social media posts and news headlines
const mockPosts = [
  // News posts
...
const SocialMediaFeed = ({ destructionLevel, interactionEvents }) => {
  ...
  // Add new posts based on user interactions
  useEffect(() => {
  ...
  // Add negative news as destruction increases
  useEffect(() => {

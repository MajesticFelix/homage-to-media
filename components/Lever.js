...
const Lever = ({ id, position, rotation, length, breakingPoint, destroyed, destructionLevel }) => {
  ...
  useFrame((state, delta) => {
    ...
    if (!destroyed) {
      // Normal lever movement - swinging back and forth
      ...
      // As destruction approaches, make movement more erratic
    ...
    if (meshRef.current.material) {
      ...
      if (destroyed) {
        // Darken and change color when broken
